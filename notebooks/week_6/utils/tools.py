...
@traceable(name="retrieve_products_context",
           description="Retrieve and rerank product context using hybrid search",
           run_type="retriever")
...
@traceable(name="retrieve_products",
           description="Retrieve relevant products via hybrid search and reranking",
           run_type="retriever")
...
@traceable(name="get_formatted_reviews_context",
           description="Retrieve and format top reviews for given products",
           run_type="retriever")
